...
router.delete('/bookshelf/:novelId', writeRateLimiter, idValidation, userController.removeFromBookshelf);

// 更新书架项（例如类型、排序标签等）
router.put('/bookshelf/:novelId', writeRateLimiter, idValidation, userController.updateBookshelfItem);
